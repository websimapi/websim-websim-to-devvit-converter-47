...
1. **Setup**: Install dependencies, register the app, and configure a test subreddit.
   \`\`\`bash
   npm run setup
   \`\`\`
   *Note: Requires Node.js and the Devvit CLI (\`npm i -g devvit\`). You will need a private subreddit (<200 members) to test.*
